...
- Добавлен ConVar `cl_discord_join_mode` для управления функцией **Join Game** в Discord (0 = открытое подключение, 1 = режим только для друзей с учетом настроек приватности Discord) [id:40d4a74]
