...
### Интерфейс : Настройки {#ui--preferences}
...
#### HUD : Уведомление о смерти {#hud--death-notice}
...
#### HUD : Таблица счета {#hud--scoreboard}
...
#### HUD : Режим наблюдателя {#hud--spectator}
...
<Table>
  ...
  <tbody>
    ...
    <tr id='hud_headname'>
      ...
      <td className='desc'>
        <div className='text'>
          Показывать имя над головой союзника или отслеживаемого игрока (команда `trackplayer`) <a className='ref-link' href='/docs/reference/configuration/commands/#trackplayer'/><br/>
          `0` Выключено<br/>
          `1` Включено<br/>
...
## Оружие от первого лица {#viewmodel}
...
<Table>
  ...
  <tbody>
    ...
    <tr id='rcon_password'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Пароль для удаленного управления сервером `rcon` <a className='ref-link' href='/docs/reference/configuration/commands/#rcon'/></td>
    </tr>
    <tr id='rcon_port'>
...
#### Сеть : Клиент : Соединение {#network--client--connection}
...
## Настройки окна и ввода {#window--input-settings}
...
## Параметры визуализации для настройки производительности {#render-tweaks-for-performance}
...
## Разработчик / Отладка {#developer--debug}
