...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='modified' id='cl_logocolor'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the color of the spray (logo)</td>
    </tr>
    <tr id='cl_logofile'>
...
<table className='docs-table'>
  ...
  <tbody>
    <tr className='added' id='cl_servers_history_lastplayed'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Removes servers from the server browser history that you played on more than the specified number of seconds ago.<br/>Default is 3 months (`7776000` seconds).<br/>Set to `0` to disable auto-removal</td>
    </tr>
    <tr className='added' id='ui_enable_menu_randomsrv'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables the 'Random Server' item in the main game menu</td>
    </tr>
    <!-- Beta -->
    <!-- tr className='added'>
    ...
    <tr className='added' id='ui_password_entry'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables the display of the password entry window in the game settings for gaining privileges on servers</td>
    </tr>
    <tr className='added' id='ui_taskbar_iconflash'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables notifications via a flashing game icon in the Windows taskbar, drawing attention to events such as connecting to a server, a new round starting, etc.</td>
    </tr>
    <tr className='added' id='ui_window_bringfront_on_event'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Automatically maximizes and brings the game window to the foreground on events like connecting to a server, a new round starting, etc.</td>
    </tr>
    <tr className='added' id='ui_window_sound_on_event'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables a sound notification to draw attention to events like connecting to a server, a new round starting, etc.</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    <tr className='added' id='dev_console'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Allows access to the in-game console without displaying the main menu (GameUI).<br/>`0` The console opens against the main menu background.<br/>`1` The console can open directly in-game (including over the loading dialog when connecting to a server)</td>
    </tr>
    <tr id='console'>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='added' id='hud_draw_only_deathnotices'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>When set to `1`, only death notices are displayed from all HUD elements (useful for recording videos)</td>
    </tr>
    ...
    <tr id='hud_fastswitch'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables fast weapon switching without needing an extra click. `1` - on, `0` - off</td>
    </tr>
    ...
    <tr className='added' id='hud_color'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the primary color for HUD elements (health, armor, timer, etc.)</td>
    </tr>
    <tr className='added' id='fov_lerp_in'>
      ...
      <td className='desc'>Speed of smooth zoom-in (FOV change) when using a scope (e.g., on sniper rifles)</td>
    </tr>
    <tr className='added' id='fov_lerp_out'>
      ...
      <td className='min'>0</td>
      <td className='max'>5</td>
      <td className='desc'>Speed of smooth zoom-out (FOV change) when exiting scope view</td>
    </tr>
    <tr className='added' id='fov_lerp_sniper_instant'>
      ...
      <td className='desc'>Instant field of view (FOV) recovery after firing a sniper rifle.<br/>Set to `0` for smooth FOV recovery (controlled by `fov_lerp_in`)</td>
    </tr>
    <tr className='added' id='cl_demo_showkeys'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Show pressed movement keys (WASD, Jump, Duck) on screen while watching a first-person demo</td>
    </tr>
    <tr className='added' id='cl_locationalpha'>
      ...
      <td className='desc'>Sets the transparency of the location name text on the map</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='added' id='cl_crosshair_drawoutline'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Adds a black outline around the crosshair for better visibility</td>
    </tr>
    <tr className='added' id='cl_crosshair_dynamic_maxdist_splitratio'>
      ...
      <td className='desc'>With `cl_crosshairstyle 2`, defines the length ratio of the inner and outer parts of the crosshair when it splits.<br/>`inner` = cl_crosshairsize * (1 - cl_crosshair_dynamic_maxdist_splitratio)<br/>`outer` = cl_crosshairsize * cl_crosshair_dynamic_maxdist_splitratio</td>
    </tr>
    <tr className='added' id='cl_crosshair_dynamic_splitalpha_innermod'>
      ...
      <td className='min'>0.0</td>
      <td className='max'>1.0</td>
      <td className='desc'>With `cl_crosshairstyle 2`, sets the transparency modifier for the INNER crosshair pips after they split</td>
    </tr>
    <tr className='added' id='cl_crosshair_dynamic_splitalpha_outermod'>
      ...
      <td className='max'>1.0</td>
      <td className='desc'>With `cl_crosshairstyle 2`, sets the transparency modifier for the OUTER crosshair pips after they split</td>
    </tr>
    <tr className='added' id='cl_crosshair_dynamic_splitdist'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>With `cl_crosshairstyle 2`, sets the distance the crosshair pips will split</td>
    </tr>
    <tr className='added' id='cl_crosshair_friendly_warning'>
      ...
      <td className='desc'>Shows a warning icon ('X') when aiming at a teammate.<br/>`0` off<br/>`1` Only for default crosshair styles<br/>`2` Always on</td>
    </tr>
    <tr className='added' id='cl_crosshair_outlinethickness'>
      ...
      <td className='desc'>Sets the thickness of the crosshair outline (from 0.1 to 3.0)</td>
    </tr>
    <tr className='added' id='cl_crosshair_recoverytime_on_fps'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Makes crosshair recovery time (after firing) dependent on FPS. `1` - dependent, `0` - independent</td>
    </tr>
    <tr className='added' id='cl_crosshair_sniper_show_normal_inaccuracy'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Includes 'no-scope' inaccuracy when calculating the blur of the sniper scope crosshair</td>
    </tr>
    ...
    <tr className='added' id='cl_crosshair_sniper_width'>
      ...
      <td className='desc'>Sets the thickness of the sniper scope lines.<br/>`1` is one pixel thick</td>
    </tr>
    <tr className='added' id='cl_crosshair_t'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables a T-shaped crosshair (removes the top line)</td>
    </tr>
    ...
    <tr className='added' id='cl_crosshaircolor'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the crosshair color in RGB format</td>
    </tr>
    <tr className='added' id='cl_crosshairdot'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Adds a dot to the center of the crosshair. If you set `cl_crosshairsize 0`, only the dot will remain</td>
    </tr>
    <tr className='added' id='cl_crosshairgap'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the size of the gap between the crosshair pips</td>
    </tr>
    <tr className='added' id='cl_crosshairgap_useweaponvalue'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>If `1`, the crosshair gap will change dynamically based on the selected weapon</td>
    </tr>
    <tr className='added' id='cl_crosshairscale'>
      ...
      <td className='desc'>Adjusts the scaling of the crosshair size based on screen resolution. `0` = Auto (Proportional), or resolution values like `480`, `640`, `1024`</td>
    </tr>
    <tr className='added' id='cl_crosshairsize'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the length of the crosshair pips</td>
    </tr>
    <tr className='added' id='cl_crosshairstyle'>
      ...
      <td className='desc'>`0` DEFAULT<br/>`1` DEFAULT STATIC<br/>`2` ACCURATE SPLIT (accurate recoil/spread with a fixed inner part)<br/>`3` ACCURATE DYNAMIC (accurate recoil/spread)<br/>`4` CLASSIC STATIC<br/>`5` OLD CS STYLE (inaccurate recoil/feedback)<br/>`6` ORIGINAL CS 1.6</td>
    </tr>
    <tr className='added' id='cl_crosshairthickness'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Adjusts the thickness of the crosshair lines</td>
    </tr>
    <tr className='added' id='cl_crosshairusealpha'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables/disables the ability to set crosshair transparency with `cl_crosshairalpha`</td>
    </tr>
    <tr className='added' id='cl_fixedcrosshairgap'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the gap size for a static crosshair</td>
    </tr>
    <tr className='added' id='weapon_debug_spread_gap'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Coefficient for `weapon_debug_spread_show 3`</td>
    </tr>
    <tr className='added' id='weapon_debug_spread_show'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables debug display of weapon spread.<br/>`1` shows a spread square.<br/>`3` shows spread using a dynamic crosshair</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='added' id='hud_radar_mapscale_dynamic_min'>
      ...
      <td className='max'>3.5</td>
      <td className='desc'>Sets the minimum scale threshold to prevent the map from becoming too small with dynamic scaling. (A scale of 0.5 usually covers the entire map)<br/><br/>See <a href='#hud_radar_mapscale_dynamic'>hud_radar_mapscale_dynamic</a></td>
    </tr>
    ...
    <tr className='added' id='hud_radar_panel_pos'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the position of the radar on the screen.<br/>`0` left<br/>`1` right</td>
    </tr>
    ...
    <tr className='added' id='hud_radar_scale'>
      ...
      <td className='max'>3</td>
      <td className='desc'>Sets the overall scale of the radar (valid values from 0.5 to 3.0)</td>
    </tr>
    <tr className='added' id='hud_radar_scale_with_scoreboard'>
      ...
      <td className='min'>0</td>
      <td className='max'>3</td>
      <td className='desc'>Sets the radar scale when the scoreboard is open. If `0`, scaling is disabled</td>
    </tr>
    ...
    <tr className='added' id='hud_radar_square_with_scoreboard'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>If `1`, the radar will become square when the scoreboard is open</td>
    </tr>
    <tr className='added' id='hud_radar_table_rotate'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Rotate the square radar when the scoreboard is open</td>
    </tr>
    <tr className='added' id='hud_radar_takeshot'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Automatically create a map image and script for the radar if they are missing</td>
    </tr>
    <tr className='added' id='hud_radar_takeshot_quality'>
      ...
      <td className='desc'>Sets the quality (in percent) of the generated map image for the radar</td>
    </tr>
    <tr className='added' id='hud_radar_x'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Radar position on the X-axis</td>
    </tr>
    <tr className='added' id='hud_radar_y'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Radar position on the Y-axis</td>
    </tr>
    <tr>
...
<table className='docs-table'>
  ...
  <tbody>
    <tr className='added' id='hud_deathnotice_draw'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Display kill notifications (killfeed)</td>
    </tr>
    <tr className='added' id='hud_deathnotice_fade'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables smooth fade-in and fade-out of kill notifications</td>
    </tr>
    <tr className='added' id='hud_deathnotice_gap'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the gap between lines in the killfeed</td>
    </tr>
    <tr className='added' id='hud_deathnotice_iconcolor'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Overrides RGBA colors for icons in the killfeed</td>
    </tr>
    <tr className='added' id='hud_deathnotice_iconscale'>
      ...
      <td className='min'>0.5</td>
      <td className='max'>5</td>
      <td className='desc'>Sets the scale of kill icons (valid values from 0.5 to 5.0)</td>
    </tr>
    <tr className='added' id='hud_deathnotice_iconshd'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the quality of kill icons.<br/>`0` low (classic)<br/>`1` high</td>
    </tr>
    <tr className='added' id='hud_deathnotice_killrarity'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Display kill rarity icons.<br/>`0` Headshot icon only<br/>`1` Display all icons</td>
    </tr>
    <tr className='added' id='hud_deathnotice_max'>
      ...
      <td className='min'>1</td>
      <td className='max'>-</td>
      <td className='desc'>Maximum number of kill notifications to display</td>
    </tr>
    <tr className='added' id='hud_deathnotice_outlinethickness'>
      ...
      <td className='max'>20</td>
      <td className='desc'>Sets the outline thickness for kill notifications</td>
    </tr>
    <tr className='added' id='hud_deathnotice_panel_pos'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the position of the killfeed.<br/>`0` left<br/>`1` right</td>
    </tr>
    <tr className='added' id='hud_deathnotice_style'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the style of kill notifications.<br/>`0` DEFAULT<br/>`1` CSO STYLE<br/>`2` CSGO STYLE (OUTLINE ONLY ON LOCAL PLAYER)<br/>`3` CSGO STYLE (OUTLINE AND BACKGROUND)</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='added' id='scoreboard_players_linespacing'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Line spacing for players in the scoreboard</td>
    </tr>
    <tr className='added' id='scoreboard_players_linespacing_fixed'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Use fixed line spacing</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    <tr className='added' id='hud_message'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Show HUD messages.<br/>`0` Disabled<br/>`1` All messages<br/>`2` HUD messages only<br/>`3` DHUD messages only</td>
    </tr>
    <tr className='added' id='hud_headname'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Show the name above a teammate's head or a tracked player's head (with 'trackplayer' command)</td>
    </tr>
    <tr id='hud_saytext'>
    ...
    <tr className='added' id='hud_saytext_fade'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables smooth fade-in and fade-out of chat messages</td>
    </tr>
    <tr className='added' id='hud_saytext_gap'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the gap between lines in the chat</td>
    </tr>
    <tr className='added' id='hud_saytext_max'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Maximum number of simultaneously displayed chat messages</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    <tr className='added' id='hud_speedometer'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enable the speedometer</td>
    </tr>
    <tr className='added' id='hud_speedometer_stayjump'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Do not update speed while the player is in the air (shows speed at the moment of the jump)</td>
    </tr>
    <tr className='added' id='hud_speedometer_x'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Speedometer position on the X-axis (-1 for center)</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr id='cam_command'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables camera control (`1` - third-person, `0` - first-person)</td>
    </tr>
    <tr id='cam_idealdist'>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='added' id='viewmodel_fov'>
      ...
      <td className='desc'>Field of View (FOV) for the weapon model in hand</td>
    </tr>
    ...
    <tr className='added' id='viewmodel_offset_x'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Viewmodel offset on the X-axis (right/left)</td>
    </tr>
    <tr className='added' id='viewmodel_offset_y'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Viewmodel offset on the Y-axis (forward/backward)</td>
    </tr>
    <tr className='added' id='viewmodel_offset_z'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Viewmodel offset on the Z-axis (up/down)</td>
    </tr>
    <tr className='added' id='viewmodel_retract'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables viewmodel retraction when approaching obstacles</td>
    </tr>
    ...
    <tr className='added' id='viewmodel_shift'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Controls viewmodel shift when looking up/down.<br/>`0` off<br/>`1` on (default)<br/>`2` auto-adjust</td>
    </tr>
    <tr className='added' id='viewmodel_shift_left_amt'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Amount the viewmodel shifts to the left when firing accuracy increases</td>
    </tr>
    <tr className='added' id='viewmodel_shift_right_amt'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Amount the viewmodel shifts to the right when firing accuracy decreases</td>
    </tr>
    <tr id='scr_ofsx'>
    ...
    <tr className='added' id='camera_movement_bone'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets a specific viewmodel bone as the view camera</td>
    </tr>
    <tr className='added' id='camera_movement_interp'>
      ...
      <td className='min'>0.1</td>
      <td className='max'>-</td>
      <td className='desc'>Smooths camera movement when switching weapons. `0` = disabled</td>
    </tr>
    <tr className='added' id='camera_movement_scale'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Camera movement scale. `0` = disabled</td>
    </tr>
    <tr id='cl_bob'>
    ...
    <tr className='added' id='cl_bob_lower_amt'>
      ...
      <td className='desc'>How much the viewmodel lowers when running</td>
    </tr>
    <tr className='added' id='cl_bob_sniper'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables bobbing for sniper rifles</td>
    </tr>
    <tr className='added' id='cl_bobamt_lat'>
      ...
      <td className='min'>0</td>
      <td className='max'>2</td>
      <td className='desc'>Amount the viewmodel moves side to side when running</td>
    </tr>
    <tr className='added' id='cl_bobamt_vert'>
      ...
      <td className='min'>0</td>
      <td className='max'>2</td>
      <td className='desc'>Amount the viewmodel moves up and down when running</td>
    </tr>
    <tr id='cl_bobcycle'>
    ...
    <tr className='added' id='cl_bobstyle'>
      ...
      <td className='min'>0</td>
      <td className='max'>3</td>
      <td className='desc'>Sets the weapon bobbing style.<br/>`0` Classic CS 1.6<br/>`1` Legacy Quakeworld<br/>`2` Improved (like CSGO)</td>
    </tr>
    <tr id='cl_bobup'>
    ...
    <tr className='added' id='cl_minviewmodel'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Use the default weapon model (v_model) for all weapons</td>
    </tr>
    <tr id='cl_righthand'>
    ...
    <tr className='added' id='cl_shieldweapon_handpreference'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Use the hand side determined by `cl_righthand` for the shield weapon model</td>
    </tr>
    <tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='added' id='cl_smokegren_color'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Color of smoke from a smoke grenade</td>
    </tr>
    <tr className='added' id='cl_smokegren_debug'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables debug visualization for smoke grenades.<br/>`0` off<br/>`1` Visualize smoke cloud radius<br/>`2` Visualize smoke particles<br/>`3` Visualize the closest position of a line blocked by smoke</td>
    </tr>
    <tr className='added' id='cl_smokegren_full_density'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables full density smoke from smoke grenades</td>
    </tr>
    <tr className='added' id='cl_corpsefall'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables smooth falling of corpses through the ground after the `cl_corpsestay` time expires; otherwise, corpses fade out smoothly</td>
    </tr>
    <tr id='cl_corpsestay'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Time in seconds before corpses disappear. `0` for instant disappearance</td>
    </tr>
    ...
    <tr className='added' id='violence_vfxblood'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables advanced blood visual effects</td>
    </tr>
    <tr className='added' id='violence_vfxblood_bigdrops'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Number of large blood drops (only from explosions or headshots)</td>
    </tr>
    <tr className='added' id='violence_vfxblood_burst_ratio'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Blood amount multiplier when a body explodes (multiplies splatter, drop effects, etc.)</td>
    </tr>
    <tr className='added' id='violence_vfxblood_color'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the color for advanced blood effects</td>
    </tr>
    <tr className='added' id='violence_vfxblood_decal_lightness'>
      ...
      <td className='min'>0.1</td>
      <td className='max'>100</td>
      <td className='desc'>Lightness factor for blood decals. (Lower values make the blood darker)</td>
    </tr>
    <tr className='added' id='violence_vfxblood_drops'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Number of blood drops</td>
    </tr>
    <tr className='added' id='violence_vfxblood_gibs'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Number of scattered gibs (only from explosions or headshots)</td>
    </tr>
    <tr className='added' id='violence_vfxblood_grenade'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables body explosion on grenade or bomb kills</td>
    </tr>
    <tr className='added' id='violence_vfxblood_headshot'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables body explosion on headshot kills</td>
    </tr>
    <tr className='added' id='violence_vfxblood_mist'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Number of blood mist effects</td>
    </tr>
    <tr className='added' id='violence_vfxblood_small'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Number of small blood particles (can leave decals on surfaces)</td>
    </tr>
    <tr className='added' id='violence_vfxblood_splat'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>Number of blood splatters</td>
    </tr>
    <tr id='traceralpha'>
    ...
    <tr className='added' id='cl_gunsmoke'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables display of smoke from the weapon barrel upon firing</td>
    </tr>
    <tr className='added' id='cl_guntracer'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables display of tracer bullets exiting the weapon barrel</td>
    </tr>
    <tr className='added' id='cl_guntracer_color'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the color of tracer bullets</td>
    </tr>
    <tr className='added' id='cl_guntracer_offset'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Distance from the barrel at which tracer bullets start to display</td>
    </tr>
    ...
    <tr className='added' id='cl_fog_skybox'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables fog to extend to the skybox (sky)</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='modified' id='cl_showfps'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Show current FPS in the corner of the screen</td>
    </tr>
    <tr id='default_fov'>
    ...
    <tr className='added' id='widescreen'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables widescreen mode (support for `16:9`, `16:10`)</td>
    </tr>
    <tr className='added' id='stretchaspect'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Stretches the image to match the screen's aspect ratio (removes black bars)</td>
    </tr>
    <tr className='added' id='engine_no_focus_sleep'>
      ...
      <td className='min'>0</td>
      <td className='max'>-</td>
      <td className='desc'>'Sleep' time (in ms) when the game window is not in focus.<br/>Set to `0` to prevent the engine from 'sleeping', so frame rate will not drop</td>
    </tr>
    <tr className='added' id='engine_no_render_minimized'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Do not update screen rendering when the game is minimized (reduces CPU and GPU load)</td>
    </tr>
    <tr id='brightness'>
    ...
    <tr className='added' id='gl_use_shaders'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables the use of the 'overbright' effect using shaders</td>
    </tr>
    <tr className='added' id='gl_reduce_shader_changes'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Reduces the number of shader switches to improve performance</td>
    </tr>
    <tr className='modified' id='gl_vsync'>
      ...
      <td className='min'>-1</td>
      <td className='max'>1</td>
      <td className='desc'>Synchronizes frame rate with monitor refresh rate.<br/>&nbsp;&nbsp;`0` Disabled<br/>&nbsp;&nbsp;`1` Standard V-Sync<br/>`-1` Adaptive V-Sync</td>
    </tr>
    ...
    <tr className='added' id='gl_lowlatency'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables low input latency mode</td>
    </tr>
    <tr className='added' id='gl_lowlatency_debugoutput'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Controls debug output for low latency mode</td>
    </tr>
    <tr className='added' id='gl_lowlatency_maxslop_ms'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the upper threshold for acceptable latency slop in milliseconds for low latency mode</td>
    </tr>
    <tr className='added' id='gl_lowlatency_minslop_ms'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the lower threshold for acceptable latency slop in milliseconds for low latency mode</td>
    </tr>
    <tr id='gl_max_size'>
    ...
    <tr className='modified' id='gl_overbright'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables overbright mode, making bright areas even brighter</td>
    </tr>
    ...
    <tr className='added' id='r_lockcull'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Freeze culling of unseen objects at the current point (for debugging)</td>
    </tr>
    <tr className='added' id='r_lockpvs'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Freeze the PVS (Potentially Visible Set) to fly around the map and see what is being rendered (for debugging)</td>
    </tr>
    <tr className='added' id='r_maxbeams'>
      ...
      <td className='desc'>Maximum number of visible beams</td>
    </tr>
    <tr id='r_mirroralpha'>
    ...
    <tr className='added' id='r_showinfo'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Show rendering/movement info</td>
    </tr>
    <tr className='added' id='r_showparticles'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Show usage statistics for particles and beams</td>
    </tr>
    <tr id='r_speeds'>
    ...
    <tr className='modified' id='cl_minmodels'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Use a single player model for each team to simplify recognition.<br/>`1` Enabled<br/>`0` Use all models</td>
    </tr>
    <tr id='cl_shadows'>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr id='voice_outputdevice'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Selects the audio API.<br/>`0` Miles<br/>`1` XAudio2</td>
    </tr>
    ...
    <tr id='voice_preprocess'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables pre-processing (cleanup) of incoming microphone data</td>
    </tr>
    <tr id='voice_profile'>
    ...
    <tr id='voice_quality'>
      ...
      <td className='max'>6</td>
      <td className='desc'>Sets the audio codec quality.<br/>`2` Speex<br/>`3` Raw<br/>`4` Silk<br/>`5` Opus<br/>`6` Opus PLC</td>
    </tr>
    ...
    <tr id='mic_inputfile'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Read data from the specified file instead of the microphone</td>
    </tr>
    <tr id='mic_outputfile'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Record microphone data to the specified file</td>
    </tr>
    <tr id='room_delay'>
    ...
    <tr id='MP3FadeTime'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Fade time for MP3 tracks</td>
    </tr>
    <tr id='MP3Volume'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Volume of MP3 tracks</td>
    </tr>
    <tr id='snd_mixahead'>
    ...
    <tr id='snd_mute_losefocus'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Mute sound when the game window is not in focus (in the background)</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='modified' id='cl_smoothtime'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Time in seconds over which the client's view is smoothed after a prediction error</td>
    </tr>
    ...
    <tr className='added' id='cl_pmove_version'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Sets the player movement code version for client-server prediction synchronization</td>
    </tr>
    ...
    <tr className='modified' id='net_graph'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Displays the network usage graph (`1`, `2`, or `3`)</td>
    </tr>
    <tr className='added' id='net_graphalpha'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Transparency of the `net_graph`</td>
    </tr>
    <tr className='added' id='net_graphheight'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Height of the `net_graph` panel</td>
    </tr>
    <tr className='added' id='net_graphheightfixed'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Fixed `net_graph` height</td>
    </tr>
    ...
    <tr className='modified' id='net_graphpos'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Position of `net_graph` on the screen (`1` - right, `2` - center, `0` - left)</td>
    </tr>
    <tr className='added' id='net_graphproportionalfont'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Determines if the `net_graph` font is proportional or not</td>
    </tr>
    <tr className='added' id='net_graphshowinterp'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Display the interpolation graph</td>
    </tr>
    <tr className='added' id='net_graphshowlatency'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Display the ping/packet loss graph</td>
    </tr>
    <tr className='added' id='net_graphsolid'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Makes the `net_graph` background opaque</td>
    </tr>
    <tr className='added' id='net_graphtext'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Display text fields</td>
    </tr>
    <tr className='modified' id='net_graphwidth'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Width of the `net_graph` panel</td>
    </tr>
    <tr className='modified' id='net_scale'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Scale of the `net_graph`</td>
    </tr>
    <tr id='ex_interp'>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr className='added' id='cl_download_delay_ms'>
      ...
      <td className='desc'>Delay in milliseconds between HTTP file downloads</td>
    </tr>
    <tr className='added' id='cl_download_demo_resources'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables downloading of missing resources during demo playback</td>
    </tr>
    <tr className='added' id='cl_download_enable_gzip'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enable Gzip compression support for fast downloads (FastDL)</td>
    </tr>
    ...
    <tr className='added' id='cl_download_multi'>
      ...
      <td className='min'>1</td>
      <td className='max'>20</td>
      <td className='desc'>Maximum number of simultaneous downloads</td>
    </tr>
    <tr className='added' id='cl_download_retries'>
      ...
      <td className='min'>0</td>
      <td className='max'>10</td>
      <td className='desc'>Maximum number of download retry attempts</td>
    </tr>
    <tr className='added' id='cl_filterstuffcmd'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Filtering level for commands the server can execute on your client.<br/>`0` off (no restrictions)<br/>`1` soft level (some commands allowed)<br/>`2` strict level (execution forbidden)</td>
    </tr>
    <tr className='added' id='cl_filterstuffcmd_notify'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Enables notifications about blocked commands the server attempted to execute on your client</td>
    </tr>
    <tr className='added' id='cl_allow_demorecord'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Allows the server to automatically start recording a demo</td>
    </tr>
    <tr className='added' id='cl_allow_redirect'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Allow redirection to another server at the current server's request</td>
    </tr>
...
<table className='docs-table'>
  ...
  <tbody>
    ...
    <tr id='sv_maxrate'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Maximum rate a client can set. `0` - no limit</td>
    </tr>
    <tr id='sv_maxspeed'>
    ...
    <tr className='added' id='sv_rcon_whitelist_address'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>If set, this IP address will never be banned for failed rcon attempts, e.g., `127.0.0.1`</td>
    </tr>
    <tr id='sv_rollangle'>
    ...
    <tr className='added' id='sv_use_entity_file'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Use an external file for entity data</td>
    </tr>
    <tr className='added' id='sv_userinfo_transmitted_fields'>
      ...
      <td className='min'>-</td>
      <td className='max'>-</td>
      <td className='desc'>Which userinfo fields are transmitted to clients</td>
    </tr>
    <tr id='sv_version'>
